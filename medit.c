...
void showstatus(void)
{
    ...
    color_c1(); printw( " F6" );  color_c2(); printw( "Texdoc! " );
    color_c1(); printw( " F7" );  color_c2(); printw( "LKMM " );
    color_c1(); printw( " F8" );  color_c2(); printw(  "NDESK " );
    color_c1(); printw( " F9" );  color_c2();  printw( "Color " );
	...
	//for (;;) 
		...
		case KEY_F(10):
			...
			break;
                ...
                case KEY_F(1):
                      clearscreen();
                      mvprintw( 1, 2 , "// texdoc (file.mrk) may look like this, create pdf with F6" );
                      mvprintw( 2, 2 , "!startdoc" );
		...
		case KEY_F(6):
			...
			k_save_quick();
			color_c2();
                        if ( fexist( file_name ) == 1 )  make_texdoc( file_name );
			break;
